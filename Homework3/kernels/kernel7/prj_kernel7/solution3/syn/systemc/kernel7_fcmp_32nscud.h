...
// ==============================================================
#ifndef __kernel7_fcmp_32nscud__HH__
#define __kernel7_fcmp_32nscud__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel7_fcmp_32nscud) {
    ...
    SC_CTOR(kernel7_fcmp_32nscud):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
