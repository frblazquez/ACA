...
architecture behav of kernel7 is 
    ...
    "kernel7,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160t-fbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.348000,HLS_SYN_LAT=4103,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=2,HLS_SYN_FF=520,HLS_SYN_LUT=5927,HLS_VERSION=2019_2}";
    ...
    signal sum_0_reg_16434 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_0_reg_16446 : STD_LOGIC_VECTOR (10 downto 0);
    signal icmp_ln6_fu_16467_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln6_reg_20637 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln6_reg_20637_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln6_reg_20637_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal i_fu_16473_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_reg_20641 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tmp_fu_16483_p1026 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_reg_20646 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_fu_18537_p1026 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_reg_20651 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_16457_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal diff_reg_20656 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal icmp_ln9_fu_20608_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln9_reg_20663 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_pp0_stage2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage2 : signal is "none";
    signal ap_block_state4_pp0_stage2_iter0 : BOOLEAN;
    signal ap_block_state8_pp0_stage2_iter1 : BOOLEAN;
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal icmp_ln9_1_fu_20614_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln9_1_reg_20668 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_16462_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_4_reg_20673 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_pp0_stage3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage3 : signal is "none";
    signal ap_block_state5_pp0_stage3_iter0 : BOOLEAN;
    signal ap_block_state9_pp0_stage3_iter1 : BOOLEAN;
    signal ap_block_pp0_stage3_11001 : BOOLEAN;
    signal sum_1_fu_20629_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ap_phi_mux_i_0_phi_fu_16450_p4 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal grp_fu_16457_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_16457_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal ap_block_pp0_stage2 : BOOLEAN;
    signal trunc_ln8_fu_16479_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal bitcast_ln9_fu_20591_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_fu_20594_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln9_fu_20604_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal or_ln9_fu_20620_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln9_fu_20624_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_16457_opcode : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component kernel7_mux_10241dEe IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    port map (
        ...
        din1 => grp_fu_16457_p1,
        opcode => grp_fu_16457_opcode,
        ce => ap_const_logic_1,
    ...
    port map (
        ...
        dout => grp_fu_16462_p2);

    kernel7_mux_10241dEe_U3 : component kernel7_mux_10241dEe
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din1022 => a_1022,
        din1023 => a_1023,
        din1024 => trunc_ln8_fu_16479_p1,
        dout => tmp_fu_16483_p1026);

    kernel7_mux_10241dEe_U4 : component kernel7_mux_10241dEe
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    i_0_reg_16446_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln6_reg_20637 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                i_0_reg_16446 <= i_reg_20641;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
    ...
    sum_0_reg_16434_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (icmp_ln6_reg_20637_pp0_iter2_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                sum_0_reg_16434 <= sum_1_fu_20629_p3;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln6_reg_20637 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                diff_reg_20656 <= grp_fu_16457_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln6_reg_20637 <= icmp_ln6_fu_16467_p2;
                icmp_ln6_reg_20637_pp0_iter1_reg <= icmp_ln6_reg_20637;
                icmp_ln6_reg_20637_pp0_iter2_reg <= icmp_ln6_reg_20637_pp0_iter1_reg;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (icmp_ln6_reg_20637_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
                icmp_ln9_1_reg_20668 <= icmp_ln9_1_fu_20614_p2;
                icmp_ln9_reg_20663 <= icmp_ln9_fu_20608_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln6_fu_16467_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_2_reg_20651 <= tmp_2_fu_18537_p1026;
                tmp_reg_20646 <= tmp_fu_16483_p1026;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (icmp_ln6_reg_20637_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then
                tmp_4_reg_20673 <= grp_fu_16462_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, icmp_ln6_fu_16467_p2, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_subdone, ap_block_pp0_stage3_subdone, ap_block_pp0_stage1_subdone, ap_block_pp0_stage2_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (icmp_ln6_fu_16467_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage1;
                elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (icmp_ln6_fu_16467_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
    ...
    and_ln9_fu_20624_p2 <= (tmp_4_reg_20673 and or_ln9_fu_20620_p2);
    ...
    ap_condition_pp0_exit_iter0_state2_assign_proc : process(icmp_ln6_fu_16467_p2)
    begin
        if ((icmp_ln6_fu_16467_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_i_0_phi_fu_16450_p4_assign_proc : process(i_0_reg_16446, icmp_ln6_reg_20637, ap_CS_fsm_pp0_stage0, i_reg_20641, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln6_reg_20637 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_phi_mux_i_0_phi_fu_16450_p4 <= i_reg_20641;
        else 
            ap_phi_mux_i_0_phi_fu_16450_p4 <= i_0_reg_16446;
        end if; 
    end process;
    ...
    ap_return <= sum_0_reg_16434;
    bitcast_ln9_fu_20591_p1 <= diff_reg_20656;

    grp_fu_16457_opcode_assign_proc : process(icmp_ln6_reg_20637, icmp_ln6_reg_20637_pp0_iter1_reg, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage2_00001, ap_block_pp0_stage1_00001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1_00001) and (icmp_ln6_reg_20637 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
            grp_fu_16457_opcode <= ap_const_lv2_1;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage2_00001) and (icmp_ln6_reg_20637_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    grp_fu_16457_p0_assign_proc : process(sum_0_reg_16434, ap_enable_reg_pp0_iter0, tmp_reg_20646, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
            grp_fu_16457_p0 <= sum_0_reg_16434;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
            grp_fu_16457_p0 <= tmp_reg_20646;
        else 
            grp_fu_16457_p0 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    end process;


    grp_fu_16457_p1_assign_proc : process(ap_enable_reg_pp0_iter0, tmp_2_reg_20651, diff_reg_20656, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
            grp_fu_16457_p1 <= diff_reg_20656;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
            grp_fu_16457_p1 <= tmp_2_reg_20651;
        else 
            grp_fu_16457_p1 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    end process;

    i_fu_16473_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_0_phi_fu_16450_p4) + unsigned(ap_const_lv11_1));
    icmp_ln6_fu_16467_p2 <= "1" when (ap_phi_mux_i_0_phi_fu_16450_p4 = ap_const_lv11_400) else "0";
    icmp_ln9_1_fu_20614_p2 <= "1" when (trunc_ln9_fu_20604_p1 = ap_const_lv23_0) else "0";
    icmp_ln9_fu_20608_p2 <= "0" when (tmp_3_fu_20594_p4 = ap_const_lv8_FF) else "1";
    or_ln9_fu_20620_p2 <= (icmp_ln9_reg_20663 or icmp_ln9_1_reg_20668);
    sum_1_fu_20629_p3 <= 
        grp_fu_16457_p2 when (and_ln9_fu_20624_p2(0) = '1') else 
        sum_0_reg_16434;
    tmp_3_fu_20594_p4 <= bitcast_ln9_fu_20591_p1(30 downto 23);
    trunc_ln8_fu_16479_p1 <= ap_phi_mux_i_0_phi_fu_16450_p4(10 - 1 downto 0);
    trunc_ln9_fu_20604_p1 <= bitcast_ln9_fu_20591_p1(23 - 1 downto 0);
end behav;
