...
reg   [7:0] zext_ln59_reg_265;
wire   [7:0] zext_ln48_fu_152_p1;
reg   [7:0] zext_ln48_reg_270;
wire   [3:0] k_fu_162_p2;
reg   [3:0] k_reg_278;
wire    ap_CS_fsm_state2;
wire   [7:0] zext_ln61_fu_180_p1;
reg   [7:0] zext_ln61_reg_283;
wire   [0:0] icmp_ln55_fu_156_p2;
reg   [5:0] dst_addr_reg_288;
wire   [3:0] n_fu_200_p2;
reg   [3:0] n_reg_296;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln57_fu_194_p2;
reg  signed [14:0] dct_coeff_table_load_reg_311;
wire    ap_CS_fsm_state4;
reg  signed [15:0] src_load_reg_316;
wire  signed [31:0] grp_fu_257_p3;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln55_fu_156_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        dst_addr_reg_288 <= zext_ln61_1_fu_189_p1;
        zext_ln61_reg_283[6 : 3] <= zext_ln61_fu_180_p1[6 : 3];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        zext_ln48_reg_270[6 : 3] <= zext_ln48_fu_152_p1[6 : 3];
        zext_ln59_reg_265[6 : 3] <= zext_ln59_fu_140_p1[6 : 3];
    end
end
...
assign add_ln58_fu_210_p2 = (zext_ln61_reg_283 + zext_ln58_1_fu_206_p1);

assign add_ln59_fu_220_p2 = (zext_ln48_reg_270 + zext_ln58_1_fu_206_p1);

assign add_ln61_1_fu_184_p2 = (zext_ln58_fu_168_p1 + zext_ln59_reg_265);
...
assign dst_address0 = dst_addr_reg_288;
...
always @ (posedge ap_clk) begin
    zext_ln59_reg_265[2:0] <= 3'b000;
    zext_ln59_reg_265[7] <= 1'b0;
    zext_ln48_reg_270[2:0] <= 3'b000;
    zext_ln48_reg_270[7] <= 1'b0;
    zext_ln61_reg_283[2:0] <= 3'b000;
    zext_ln61_reg_283[7] <= 1'b0;
end
