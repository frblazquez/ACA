...
dct_1d2::dct_1d2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    dct_mac_muladd_15cud_U1->din0(dct_coeff_table_load_reg_311);
    dct_mac_muladd_15cud_U1->din1(src_load_reg_316);
    dct_mac_muladd_15cud_U1->din2(tmp_0_reg_120);
    dct_mac_muladd_15cud_U1->dout(grp_fu_257_p3);
    ...
    sc_trace(mVcdFile, zext_ln59_reg_265, "zext_ln59_reg_265");
    sc_trace(mVcdFile, zext_ln48_fu_152_p1, "zext_ln48_fu_152_p1");
    sc_trace(mVcdFile, zext_ln48_reg_270, "zext_ln48_reg_270");
    ...
    sc_trace(mVcdFile, zext_ln61_reg_283, "zext_ln61_reg_283");
    sc_trace(mVcdFile, icmp_ln55_fu_156_p2, "icmp_ln55_fu_156_p2");
    sc_trace(mVcdFile, dst_addr_reg_288, "dst_addr_reg_288");
    sc_trace(mVcdFile, n_fu_200_p2, "n_fu_200_p2");
    sc_trace(mVcdFile, n_reg_296, "n_reg_296");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, icmp_ln57_fu_194_p2, "icmp_ln57_fu_194_p2");
    sc_trace(mVcdFile, dct_coeff_table_load_reg_311, "dct_coeff_table_load_reg_311");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, src_load_reg_316, "src_load_reg_316");
...
void dct_1d2::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
        ...
        k_0_reg_98 = k_reg_278.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        k_0_reg_98 = ap_const_lv4_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        n_0_reg_109 = n_reg_296.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(icmp_ln55_fu_156_p2.read(), ap_const_lv1_0))) {
        n_0_reg_109 = ap_const_lv4_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        tmp_0_reg_120 = grp_fu_257_p3.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(icmp_ln55_fu_156_p2.read(), ap_const_lv1_0))) {
        tmp_0_reg_120 = ap_const_lv32_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        dct_coeff_table_load_reg_311 = dct_coeff_table_q0.read();
        src_load_reg_316 = src_q0.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln55_fu_156_p2.read(), ap_const_lv1_0))) {
        dst_addr_reg_288 =  (sc_lv<6>) (zext_ln61_1_fu_189_p1.read());
        zext_ln61_reg_283 = zext_ln61_fu_180_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        k_reg_278 = k_fu_162_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        n_reg_296 = n_fu_200_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        zext_ln48_reg_270 = zext_ln48_fu_152_p1.read();
        zext_ln59_reg_265 = zext_ln59_fu_140_p1.read();
    }
}

void dct_1d2::thread_add_ln58_fu_210_p2() {
    add_ln58_fu_210_p2 = (!zext_ln61_reg_283.read().is_01() || !zext_ln58_1_fu_206_p1.read().is_01())? sc_lv<8>(): (sc_biguint<8>(zext_ln61_reg_283.read()) + sc_biguint<8>(zext_ln58_1_fu_206_p1.read()));
}

void dct_1d2::thread_add_ln59_fu_220_p2() {
    add_ln59_fu_220_p2 = (!zext_ln48_reg_270.read().is_01() || !zext_ln58_1_fu_206_p1.read().is_01())? sc_lv<8>(): (sc_biguint<8>(zext_ln48_reg_270.read()) + sc_biguint<8>(zext_ln58_1_fu_206_p1.read()));
}

void dct_1d2::thread_add_ln61_1_fu_184_p2() {
    add_ln61_1_fu_184_p2 = (!zext_ln58_fu_168_p1.read().is_01() || !zext_ln59_reg_265.read().is_01())? sc_lv<8>(): (sc_biguint<8>(zext_ln58_fu_168_p1.read()) + sc_biguint<8>(zext_ln59_reg_265.read()));
}
...
void dct_1d2::thread_dst_address0() {
    dst_address0 = dst_addr_reg_288.read();
}
