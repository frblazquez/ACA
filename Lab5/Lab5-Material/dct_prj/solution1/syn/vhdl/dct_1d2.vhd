...
architecture behav of dct_1d2 is 
    ...
    signal zext_ln59_reg_265 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln48_fu_152_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln48_reg_270 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal zext_ln61_reg_283 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln55_fu_156_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                dst_addr_reg_288 <= zext_ln61_1_fu_189_p1(6 - 1 downto 0);
                    zext_ln61_reg_283(6 downto 3) <= zext_ln61_fu_180_p1(6 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                    zext_ln48_reg_270(6 downto 3) <= zext_ln48_fu_152_p1(6 downto 3);
                    zext_ln59_reg_265(6 downto 3) <= zext_ln59_fu_140_p1(6 downto 3);
            end if;
        end if;
    end process;
    zext_ln59_reg_265(2 downto 0) <= "000";
    zext_ln59_reg_265(7) <= '0';
    zext_ln48_reg_270(2 downto 0) <= "000";
    zext_ln48_reg_270(7) <= '0';
    zext_ln61_reg_283(2 downto 0) <= "000";
    zext_ln61_reg_283(7) <= '0';
    ...
    add_ln58_fu_210_p2 <= std_logic_vector(unsigned(zext_ln61_reg_283) + unsigned(zext_ln58_1_fu_206_p1));
    add_ln59_fu_220_p2 <= std_logic_vector(unsigned(zext_ln48_reg_270) + unsigned(zext_ln58_1_fu_206_p1));
    add_ln61_1_fu_184_p2 <= std_logic_vector(unsigned(zext_ln58_fu_168_p1) + unsigned(zext_ln59_reg_265));
