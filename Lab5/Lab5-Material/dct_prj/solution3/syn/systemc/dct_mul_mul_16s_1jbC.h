...
// ==============================================================
#ifndef __dct_mul_mul_16s_1jbC__HH__
#define __dct_mul_mul_16s_1jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mul_mul_16s_1jbC) {
    ...
    SC_CTOR(dct_mul_mul_16s_1jbC):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
